...
/*
 * Impact - records data related to striking a damaged road.
 *
 ...
 * @acceleration: vehicle 3-axis acceleration in gs (gravity).
 */
class Impact : Loggable, Uploadable
{
        public:
                String log();
